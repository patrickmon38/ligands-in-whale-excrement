---
title: Code for figures in *'Large pool of organic ligands supports iron bioavailability
  and reduces copper toxicity in whale excrement'* by Monreal et al.
output:
  html_document:
    df_print: paged
---
...
mzxcms_FT = xcmsRaw("~/NOT_Downloads_Folder/UW/Bundy_Lab/WHALE/Data/FT Data/WHALE_Mn19.mzXML",profstep=0.02,profmethod="bin",profparam=list(),includeMSn=FALSE,mslevel=NULL, scanrange=NULL)
